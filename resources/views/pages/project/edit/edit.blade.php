...
@section('content')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Редактировать проект {{ $project['name']['ru'] }}</h1>
    <!-- end page-header -->
    <!-- begin panel -->
        ...
        <form action="{{ route('admin.project.update', ['project' => $project['id']]) }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="panel-body p-t-10">
                    ...
                    <div class="col-xl-8">
                        ...
                        <ul class="nav nav-pills m-10">
                            ...
                            <div class="switcher p-5">
                                <input type="checkbox" name="status" id="status" {{ $project['status']?'checked':'' }} value="1">
                        ...
                        @foreach($languages as $lang)
                            <!-- begin tab-pane -->
                                <div class="tab-pane fade{{(!$loop->index)?' active show':''}}"
                                    ...
                                    <textarea class="form-control" name="short_description[{{$lang->url}}]" rows="3">{{$project['short_description'][$lang->url]}}</textarea>
                    ...
                    <div class="col-xl-4">
                        <div class="row">
                            ...
                            <div class="col-xl-7 mt-3">
                                <img id="image-src" src="{{ $project['image'] }}" width="100%">
                            </div>
                            <!-- end col-6 -->
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-xl-7 mt-3">
                                <img id="cover_image-src" src="{{ $project['cover_image'] }}" width="100%">
                            </div>
                            <!-- end col-6 -->
                        </div>
                    </div>
                ...
                <div class="form-group col-md-6">
                    <input type="hidden" class="form-control" name="point_x" value="{{ $project['point_x'] }}"
                           id="coordinateX"/>
                    <span class="text-danger error-text" id="errorCoordinateX" style="position:absolute">
                </span>
                </div>
                <div class="form-group col-md-6">
                    <input type="hidden" class="form-control" name="point_y" value="{{ $project['point_y'] }}"
                           id="coordinateY"/>
                    ...
                    @foreach($project['images'] as $image)
                        <div class="superbox-list">
                            <a href="javascript:;" class="superbox-img">
                                <img data-img="{{ $image['image'] }}" />
                                <span style="background: url({{ $image['image'] }});">
