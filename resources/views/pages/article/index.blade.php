...
@section('content')
	...
	<div class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <a href="{{ route('admin.article.create') }}" class="btn btn-xs btn-success mr-3">Добавить</a>
				...
				<tbody>
                    @foreach($articles as $item)
                        <tr>
                            ...
                            <td align="center">
                                <a href="{{ route('admin.article.edit', ['article' => $item->id]) }}" class="btn btn-icon btn-primary"><i class="fas fa-pencil-alt"></i></a>
                            </td>
                        </tr>
                    @endforeach
				</tbody>
