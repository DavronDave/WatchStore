...
@section('title', 'Категории нормативных актов')
...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Категории нормативных актов</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Категории нормативных актов</h1>
    <!-- end page-header -->
    <!-- begin panel -->
        ...
        <div class="modal fade" id="createModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{route('admin.regulation-category.store')}}" class="form-group"
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.regulation-category.update')}}" class="form-group"
                      enctype="multipart/form-data" method="POST">
                    <!-- Modal body -->
                    @csrf
                    <div class="modal-body">
...
@push('scripts')
    ...
    <script>
        function editCategory(category_id) {
            if (category_id) {
                $.ajax({
                    url: "{{ url('/admin/regulation-categories/edit') }}/" + category_id,
                    type: "GET",
                    dataType: "json",
