...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Нормативные акты</li>
    </ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Нормативные акты</h1>
	<!-- end page-header -->
	<!-- begin panel -->
	<div class="panel panel-inverse">
		<!-- begin panel-heading -->
        <div class="panel-heading">
            <h4 class="panel-title">Список нормативных актов</h4>
            <a href="{{ route('admin.regulation.create') }}" class="btn btn-xs btn-success mr-3">Добавить</a>
			...
			<table id="data-table-fixed-columns" class="table table-striped table-bordered table-td-valign-middle" cellspacing="0" width="100%">
				<thead>
					<tr>
						...
						<th class="text-nowrap">Количество загрузок</th>
				...
				<tbody>
                    @foreach($regulations as $item)
                        <tr>
                            ...
                            <td align="center">
                                <a href="{{ route('admin.regulation.edit', ['regulation' => $item->id]) }}" class="btn btn-icon btn-primary"><i class="fas fa-pencil-alt"></i></a>
                            </td>
                        </tr>
                    @endforeach
				</tbody>
